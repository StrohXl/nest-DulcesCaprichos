export const ConfirmToken = (
  ...
  xmlns:v="urn:schemas-microsoft-c om:vml"
...
<![endif]-->
      ...
      style="
       margin: 0px auto;
      max-width: 600px;
      background: linear-gradient(#ffffffe0,#ffffffe0), url(https://images.unsplash.com/photo-1612831197310-ff5cf7a211b6?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZXN0dWRpYW5kbyUyMGNvbiUyMGxhcHRvcHxlbnwwfHwwfHx8MA%3D%3D);
                            ...
                            >
                              <div
                                style="
                                  ...
                                  mso-ansi-font-size: 48px;
                                "
                                >Confirme el token en la pagina para validar su
                                correo</div
                              >
                            </p>
                            <p style="color: #000;">
                                <div  style="
                                  ...
                                  ">
                                    ...
                                    <span class='number' id=' number numeros'>${value1}</span>
                                    <span class='number' id=' number numeros'>${value2}</span>
                                    <span class='number' id=' number numeros'>${value3}</span>
                                    <span class='number' id=' number numeros'>${value4}</span>
                                    <span class='number' id=' number numeros'>${value5}</span>
                                    </div>
                                </div>
                              </p>
                          </div>
...
<![endif]-->
      ...
      >
        <table
          ...
          cellspacing="0"
          role="presentation"
          style="background: #843292; background-color: #843292; width: 100%"
        >
          <tbody>
            <tr style="display: flex; align-items: center; padding: 5px 20px;height:30px">
              ...
              <td style="width:100%"></td>
               <td align="right"  style="text-align: right ;display: flex;  align-items: center;">
